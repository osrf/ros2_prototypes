...
int main(int argc, char** argv) {
    int loop_count = 1000;
    std::cout << "Loop " << loop_count << "M. Produce a LargeBoostMessage_Method. Copy message. Consume message."  << std::endl;
    loop_count *= 1000 * 1000;

    LargeBoostMessage_Method msg;
    LargeBoostMessage_Method msg2;
    ...
    std::cout << "msg2.baz[42] " << msg2.get_baz()[42] << std::endl;
